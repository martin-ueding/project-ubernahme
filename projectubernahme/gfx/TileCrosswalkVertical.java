...
public class TileCrosswalkVertical extends ConvertedGraphics {
	...
	private void paintShapeNode_0_0_0_0(Graphics2D g) {
		...
		Rectangle2D.Double shape0 = new Rectangle2D.Double(0.0, 1012.3621826171875, 40.0, 40.0);
		g.fill(shape0);
	}

	private void paintShapeNode_0_0_0_1(Graphics2D g) {
		g.setPaint(new Color(0, 0, 0, 255));
		Rectangle2D.Double shape1 = new Rectangle2D.Double(0.0, 1042.3621826171875, 40.0, 10.0);
		g.fill(shape1);
	}

	private void paintShapeNode_0_0_0_2(Graphics2D g) {
		Rectangle2D.Double shape2 = new Rectangle2D.Double(0.0, 1022.3621826171875, 40.0, 10.0);
		g.fill(shape2);
	}
